    ...
    <div className="report-container">
      ...
      <div className="report-row">
        <div className="report-card">
          <h3>🚗 出行方式覆盖对比</h3>
          {fullModeData && <ModeComparisonChart data={fullModeData} activeMode={activeMode} />}
        </div>

        <div className="report-card">
          <h3>⏱️ 时间维度覆盖</h3>
          {fullModeData && fullModeData[activeMode]?.time_slots && (
            <TimeSlotChart data={fullModeData[activeMode].time_slots} activeTimeSlot={activeTimeSlot} />
          )}
        </div>
      </div>
